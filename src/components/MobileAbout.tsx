...
export default function MobileAbout() {
  ...
  return (
    ...
    >
      ...
      <div className="flex px-5 gap-4 mb-4">
        <motion.a
      ...
      <div className="p-4">
        ...
        />
        <h1 className="text-2xl font-bold pt-2 dark:border-gray-500/30 text-center border-t-2 mb-2">Hello, I&#39;m Hemanth Kumar</h1>
        <h2 className="text-lg font-semibold text-yellow-500 text-center mb-2">Developer</h2>
      ...
      <motion.div variants={containerVariants} className="grid py-6 px-4 grid-cols-1 sm:grid-cols-2 gap-4">
                <Card>
                  <CardContent className="p-4 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Analytical thinker with a knack for elegant solutions
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-4 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">5+ years of industry experience</p>
                    </div>
                  </CardContent>
                </Card>
